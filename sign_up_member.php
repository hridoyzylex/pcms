...
<link rel="stylesheet" href="css/sign_up_member.css" type="text/css" media="all">
  ...
  <form name="member_registration" method="post" action="save_member.php">
    <hr>
        <div class="accounttype">
          ...
          <input type="text" name="nsu_id" id="name" placeholder="NSU ID" required/>
