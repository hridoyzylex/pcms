...
<div class=container>
	<?php 
		...
		if(!mysqli_connect_errno())
		{
			$result = mysqli_query($con, "SELECT * FROM member WHERE username = '$_SESSION[username]'");
	...
	<form name = "edit_account" method = "post"  action = "save_account_member.php">
	<table style="color: black">
		...
		<tr>
			<td> NSU ID:</td>
			<td><input type = "text" name = "nsu_id" id = "nsu_id" size = "40" required = "required" value = "<?php echo $row["nsu_id"]; ?>"></td>
		</tr>
		<tr>
			<td> Date of Birth:</td>
